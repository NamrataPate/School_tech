...
?>
    ...
    <div class="container">
      <div class="row addrow">
        <div class="col-lg-3 col-md-6 col-sm-6 activity">
          <div class="single-activity">
            <div class="single-activity-icon">
              <i class="fa fa-gamepad iconsize"></i>
            </div>
            <h4>Funny Games</h4>
            <p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 activity">
          <div class="single-activity">
            <div class="single-activity-icon">
              <i class="fa fa-fort-awesome iconsize"></i>
            </div>
            <h4>Toys</h4>
            <p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 activity">
          <div class="single-activity mrg-res-top-md">
            <div class="single-activity-icon">
              <i class="fa fa-futbol-o iconsize"></i>
            </div>
            <h4>Activities</h4>
            <p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 activity">
          <div class="single-activity mrg-res-top-md">
            <div class="single-activity-icon">
              <i class="fa fa-pencil iconsize"></i>
            </div>
            <h4>Education</h4>
            <p>
  ...
  <div class="advertise-area text-center bgsection">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>
...
<div class="section">
  <div class="container">
    ...
    <p class="text-center mt-1">Our preschool program has six dedicated classes</p>
    <div id="nav-icon1">
      <span class="span1"></span>
      <span class="fa fa-graduation-cap spani"></span>
